...
const styles = StyleSheet.create({
  ...
  deptHeaderTitle: { fontSize: 22, fontWeight: '800', color: '#0f172a', letterSpacing: -0.3 },
  deptHeaderSub: { marginTop: 4, fontSize: 13, color: '#64748b', fontWeight: '500', lineHeight: 18 },
  deptTotalBadge: {
    borderRadius: 10,
  ...
  deptTotalBadgeText: { fontSize: 12, fontWeight: '800', color: '#166534' },
  deptNameInputWrap: {
    marginTop: 16,
    borderWidth: 1,
    borderColor: '#e2e8f0',
  ...
  deptNameInput: { paddingVertical: 12, fontSize: 14, color: BrandColors.text },
  deptAddPrimaryBtn: {
    marginTop: 14,
    width: '100%',
    flexDirection: 'row',
  ...
  timeHeroTitle: { fontSize: 16, fontWeight: '800', color: '#0f172a', letterSpacing: -0.2 },
  timeHeroSub: { marginTop: 4, fontSize: 13, color: '#64748b', fontWeight: '500', lineHeight: 18 },
  ...
  adminRoleTitle: { marginTop: 14, fontSize: 20, fontWeight: '800', color: '#0f172a', letterSpacing: -0.2 },
  adminRoleUserName: { marginTop: 8, fontSize: 17, color: '#0f172a', fontWeight: '800' },
  adminRoleUserId: { marginTop: 4, fontSize: 13, color: '#94a3b8', fontWeight: '600' },
  ...
  adminRoleOptionText: { flex: 1, fontSize: 15, color: '#1e293b', fontWeight: '800' },
  adminRoleOptionTextSelected: { color: '#2563eb' },
  adminRoleCancelBtn: {
    marginTop: 18,
    height: 48,
    borderRadius: 14,
  ...
  adminRoleCancelBtnText: { fontSize: 15, color: '#64748b', fontWeight: '800' },
  ...
  filterDateFieldPlaceholder: { color: '#94a3b8', fontWeight: '600' },
  filterDateClear: { alignSelf: 'flex-start', marginTop: 8, paddingVertical: 4 },
  filterDateClearText: { fontSize: 13, fontWeight: '700', color: '#2563eb' },
  projectCard: {
    flexDirection: 'row',
    overflow: 'hidden',
    borderWidth: 1,
  ...
  projectTitle: { flex: 1, minWidth: 0, flexShrink: 1, fontSize: 17, fontWeight: '900', color: '#0f172a' },
  projectStatePill: {
    marginTop: 8,
    alignSelf: 'flex-start',
    flexDirection: 'row',
  ...
  formLabelMuted: { fontSize: 11, fontWeight: '600', color: '#94a3b8' },
  ...
  hrAssignSelectOptionActive: { backgroundColor: '#eef2ff' },
  hrAssignSelectOptionText: { fontSize: 13, color: '#475569', fontWeight: '600', flex: 1 },
  hrAssignSelectOptionTextActive: { color: '#1d4ed8', fontWeight: '800' },
  ...
  attachmentFileText: { flex: 1, minWidth: 0, fontSize: 12, color: '#475569', fontWeight: '600' },
